...
def main():
    ...
    ap.add_argument("--slot-dropout-p", type=float, default=0.0,
                    help="Train-time per-(batch,slot) probability of dropping a slot's injection. Forces robustness to subset of K → encourages spreading info.")
